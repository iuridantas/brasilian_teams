...
export function CreateseriesA() {
  ...
  async function getTeamSerieAById() {
    if (_id) {
      const team = await api.getTeamSerieAById(_id);
      setTeams(team);
    }
  }
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    if (_id) {
      ...
      TeamResponse = await api.updateTeamSerieA(teamToUpdate);
      console.log(TeamResponse);
    } else {
      TeamResponse = await api.creatTeamSerieA(newTeam);
    }
