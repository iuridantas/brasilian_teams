...
export function CreateseriesDGroup1() {
  ...
  useEffect(() => {
    getTeamSerieDGroup1ById();
  }, []);

  async function getTeamSerieDGroup1ById() {
    if (_id) {
      const team = await api.getTeamSerieDGroup1ById(_id);
      setTeams(team);
    }
  }
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    if (_id) {
      ...
      TeamResponse = await api.updateTeamSerieDGroup1(teamToUpdate);
